...
using Lykke.Job.OpsGenie.Settings;
using Lykke.Job.OpsGenie.Modules;
using Lykke.Logs;
...
namespace Lykke.Job.OpsGenie
{
    ...
    public class Startup
    {
        ...
        private const string ApiName = "OpsGenie API";
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                services.AddLykkeLogging(
                    settingsManager.ConnectionString(s => s.OpsGenieJob.Db.LogsConnString),
                    "OpsGenieLog",
                ...
                builder.RegisterModule(new JobModule(appSettings.OpsGenieJob, settingsManager.Nested(x => x.OpsGenieJob)));
